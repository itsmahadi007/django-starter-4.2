...
urlpatterns = [
    ...
    path("api/email_verify_request/v2/", request_email_verification),
    path("api/verify_email_token/v2/", verify_email_token),
    path("api/request_phone_verification/v2/", request_phone_verification),
    path("api/verify_phone_token/v2/", verify_phone_token),
    # password reset
